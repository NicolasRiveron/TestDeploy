    ...
    useEffect(() => {
        ...
        monedas.forEach(mon => {
            ...
            transacciones.forEach((trn) => {
                if (trn.moneda === mon.id && trn.tipo_operacion === 1) {
        ...
        <section className="text-center col-lg-6 mb-4">
            <div className="card shadow mb-4">
                ...
                <div className="card-header py-3">
                    <h6 className="m-0 font-weight-bold text-capitalize">Gráfico de montos comprados por moneda</h6>
                </div>
                {/* <!-- END HEADER CARD --> */}
                ...
                <div className="card-body">
                    {(grafica.length === 0) ? <p>Cargando grafica...</p> : <Bar
                        ...
                        data={{
                            ...
                            datasets: [
                                {
                                    label: 'monto gastado en compras',
                                    data: grafica.map(mon => mon.total),
                                    backgroundColor: 'rgba(18, 163, 225, 0.8)'
                                }
                            ]
                        }} />
